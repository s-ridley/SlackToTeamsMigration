            ...
            if (!string.IsNullOrWhiteSpace(slackReaction)) {
                ...
                if (string.IsNullOrWhiteSpace(result)) {
                    result = slackReaction switch {
                        ...
                        "arrow_up" => Emoji.UpArrow,
                        "ballot_box_with_check" => Emoji.BallotBoxWithBallot,
                        ...
                        "fast_forward" => Emoji.FastForwardButton,
                        ...
                        "large_orange_circle" => Emoji.OrangeCircle,
                        "large_orange_square" => Emoji.OrangeSquare,
                        "large_yellow_circle" => Emoji.YellowCircle,
                        "large_yellow_square" => Emoji.YellowSquare,
                        "large_green_circle" => Emoji.GreenCircle,
                        "large_green_square" => Emoji.GreenSquare,
                        "large_blue_circle" => Emoji.BlueCircle,
                        "large_blue_square" => Emoji.BlueSquare,
                        "large_purple_circle" => Emoji.PurpleCircle,
                        "large_purple_square" => Emoji.PurpleSquare,
                        "large_brown_circle" => Emoji.BrownCircle,
                        "large_brown_square" => Emoji.BrownSquare,
                        "large_red_square" => Emoji.RedSquare,
                        ...
                        "mag_right" => Emoji.MagnifyingGlassTiltedRight,
                        ...
                        "rotating_light" or "siren" => Emoji.PoliceCarLight,
                        "rubberduck" => Emoji.Duck,
                        "runner" => Emoji.PersonRunning,
                        "santa" => Emoji.SantaClaus,
                        ...
                        "sleeping_accommodation" => Emoji.Bed,

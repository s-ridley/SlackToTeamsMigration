...
namespace EmojiListGenerator.Services {
    internal class GeneratorService(IConfiguration config) : IGeneratorService {
        #region Constants
        ...
        public async Task RunAsync() {
            ...
            string? tempSourceUrl = config.GetValue<string>("EmojiSourceUrl");
            if (!string.IsNullOrWhiteSpace(tempSourceUrl)) {
                SourceUrl = tempSourceUrl;
            }
            float? tempMaxVersion = config.GetValue<float>("MaxVersion");
